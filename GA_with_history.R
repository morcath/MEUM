# source: https://github.com/luca-scr/GA/blob/master/R/ga.R
# added historical knowledge by Aleksander Tym and Filip Kuchta 
##############################################################################
#                                                                            #
...
summary.ga <- function(object, ...)
{
  ...
  out <- list(type = object@type,
              ...
              history = object@history,       # 4 - print actual history var
              domain = domain,
              suggestions = suggestions,
              iter = object@iter,
